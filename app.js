(function(){
  ...
  function injetarAbaAnalises(){
    ...
    panel.innerHTML =
      ...
      +   '#tabAnalises #analisesFreqLegenda .kpi-item{min-width:0;max-width:100%;box-sizing:border-box;}'
      +   '#tabAnalises #analisesFreqLegenda .kpi-item label{font-size:12.5px;white-space:normal;}'
      +   '#tabAnalises #analisesFreqLegenda .kpi-item span{font-size:15.6px;word-break:break-word;}'
      + '</style>'
